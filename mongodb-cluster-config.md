...
​	
2.创建keyfile
> 随便用什么方式生成一个keyfile文件，文件内容必须是6-1024个字符。
>
...
> 修改每个实例的mongod.conf文件，在security节点下，增加配置  keyFile： mongodb-key.keyfile。
>
> 注意这里配置的是keyfile的路径，如果不在当前目录下，就需要写上绝对路径。
>
> 每个节点的配置文件中，都要加上这句，并且要使用相同的keyfile
>
...
## 全文参考： ##
[http://www.jianshu.com/p/2825a66d6aed](http://www.jianshu.com/p/2825a66d6aed)
